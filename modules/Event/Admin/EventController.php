...
class EventController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'          => __("Restaurant Management")
        ];
    ...
    public function recovery(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'          => __("Recovery Restaurant Management")
        ];
        return view('Event::admin.index', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            ...
            'breadcrumbs'       => [
                ...
                [
                    'name'  => __('Add Restaurant'),
                    'class' => 'active'
                ],
            ],
            'page_title'        => __("Add new Restaurant")
        ];
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($res) {
            ...
            if ($id > 0) {
                ...
                return back()->with('success', __('Restaurant updated'));
            } else {
                event(new CreatedServicesEvent($row));
                return redirect(route('event.admin.edit', $row->id))->with('success', __('Restaurant created'));
            }
        }
    }
