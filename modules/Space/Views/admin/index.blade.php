...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{!empty($recovery) ? __('Recovery') : __("All Culture")}}</h1>
            <div class="title-actions">
                @if(empty($recovery))
                <a href="{{route('space.admin.create')}}" class="btn btn-primary">{{__("Add new culture")}}</a>
                @endif
            </div>
        </div>
            ...
            <div class="panel-body">
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                        ...
                        @else
                            <tr>
                                <td colspan="7">{{__("No culture found")}}</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
