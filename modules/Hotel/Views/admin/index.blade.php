...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{!empty($recovery) ? __('Recovery') : __("All Tour Guides")}}</h1>
            <div class="title-actions">
                @if(empty($recovery))
                <a href="{{route('hotel.admin.create')}}" class="btn btn-primary">{{__("Add new tour guide")}}</a>
                @endif
            </div>
        </div>
            ...
            <div class="panel-body">
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{route('hotel.admin.edit',['id'=>$row->id])}}">{{__("Edit Tour Guide")}}</a>
                                                <a class="dropdown-item" href="{{route('hotel.admin.room.index',['hotel_id'=>$row->id])}}">{{__("Manage Tour Guide")}}</a>
                                                <a class="dropdown-item" href="{{route('hotel.admin.room.availability.index',['hotel_id'=>$row->id])}}">{{__("Manage Tour Guide Availability")}}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        @else
                            <tr>
                                <td colspan="7">{{__("No Tour Guide found")}}</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
