...
class VendorController extends FrontendController
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Manage Tour Guides"),
        ];
    ...
    public function recovery(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Recovery Tour Guides"),
        ];
        return view('Hotel::frontend.vendorHotel.index', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Create Tour Guide"),
        ];
    ...
    public function store( Request $request, $id ){
        ...
        if ($res) {
            ...
            if($id > 0 ){
                ...
                return back()->with('success',  __('Tour Guide updated') );
            }else{
                event(new CreatedServicesEvent($row));
                return redirect(route('hotel.vendor.edit',['id'=>$row->id]))->with('success', __('Tour Guide created') );
            }
        }
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $row = $row->find($id);
        if (empty($row)) {
            return redirect(route('hotel.vendor.index'))->with('warning', __('Tour Guide not found!'));
        }
    ...
    public function delete($id)
    {
        ...
        return redirect(route('hotel.vendor.index'))->with('success', __('Delete tour guide success!'));
    }
    ...
    public function restore($id)
    {
        ...
        return redirect(route('hotel.vendor.recovery'))->with('success', __('Restore tour guide success!'));
    }
