...
@section('content')
	<div class="container-fluid">
		<div class="d-flex justify-content-between mb20">
			<h1 class="title-bar">{{!empty($recovery) ? __('Recovery') : __("All Nature")}}</h1>
			<div class="title-actions">
				@if(empty($recovery))
					<a href="{{route('flight.admin.create')}}" class="btn btn-primary">{{__("Add new nature")}}</a>
				@endif
			</div>
		</div>
				...
				<form action="" class="bravo-form-item">
					<div class="table-responsive">
						<table class="table table-hover">
							...
							@else
								<tr>
									<td colspan="7">{{__("No nature found")}}</td>
								</tr>
							@endif
							</tbody>
						</table>
