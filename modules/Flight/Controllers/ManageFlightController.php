...
class ManageFlightController extends FrontendController
{
    ...
    public function restore($id)
    {
        ...
        return redirect(route('flight.vendor.recovery'))->with('success', __('Restore nature success!'));
    }
    ...
    public function store( Request $request, $id ){
        ...
        if ($res) {
            ...
            if($id > 0 ){
                ...
                return back()->with('success',  __('Nature updated') );
            }else{
                event(new CreatedServicesEvent($row));
                return redirect(route('flight.vendor.edit',['id'=>$row->id]))->with('success', __('Nature created') );
            }
        }
    }
    ...
    public function editFlight(Request $request, $id)
    {
        ...
        $row = $row->find($id);
        if (empty($row)) {
            return redirect(route('flight.vendor.index'))->with('warning', __('Nature not found!'));
        }
        $data = [
            'translation'    => $row,
            'row'           => $row,
    ...
    public function deleteFlight($id)
    {
        ...
        return redirect(route('flight.vendor.index'))->with('success', __('Delete nature success!'));
    }
	...
	public function cloneFlight(Request $request,$id){
		...
		try{
			...
			return redirect()->back()->with('success',__('Nature clone was successful'));
