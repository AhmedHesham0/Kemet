...
class ManageTourController extends FrontendController
{
    ...
    public function recovery(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'  => __("Recovery Packages"),
        ];
        return view('Tour::frontend.manageTour.index', $data);
    }
    ...
    public function restore($id)
    {
        ...
        return redirect(route('tour.vendor.recovery'))->with('success', __('Restore package success!'));
    }
    ...
    public function editTour(Request $request, $id)
    {
        ...
        $row = $row->find($id);
        if (empty($row)) {
            return redirect(route('tour.vendor.index'))->with('warning', __('Package not found!'));
        }
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($res) {
            ...
            if ($id > 0) {
                ...
                return redirect(route('tour.vendor.edit', ['id' => $row->id]))->with('success', __('Package created'));
            }
        }
    }
    ...
    public function deleteTour($id)
    {
        ...
        return redirect(route('tour.vendor.index'))->with('success', __('Delete package success!'));
    }
