...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(!empty($recovery) ? __('Recovery') : __("All Culture")); ?></h1>
            <div class="title-actions">
                <?php if(empty($recovery)): ?>
                <a href="<?php echo e(route('space.admin.create')); ?>" class="btn btn-primary"><?php echo e(__("Add new culture")); ?></a>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="panel-body">
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7"><?php echo e(__("No culture found")); ?></td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\modules/Space/Views/admin/index.blade.php ENDPATH**/ ?>