        ...
        <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(empty($item['hide_in_filter_search'])): ?>
                ...
                <div class="filter-item">
                    <div class="filter-title"><strong><?php echo e(__($translate->name)); ?></strong></div>
...
<?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\themes/Mytravel/Hotel/Views/frontend/layouts/search-map/advance-filter.blade.php ENDPATH**/ ?>