                ...
                <div class="card-body px-4 pt-0">
                    <ul class="list-unstyled font-size-1 mb-0 font-size-16">
                        ...
                        <?php if(!empty($price_item)): ?>
                            <li class="d-flex justify-content-between py-2">
                                <div class="label"><?php echo e(__('Ticket price')); ?>
...
</div><?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\themes/Mytravel/Boat/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>