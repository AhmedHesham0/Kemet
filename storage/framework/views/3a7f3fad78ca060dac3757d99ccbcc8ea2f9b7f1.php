                ...
                <div class="border-bottom">
                    <div class="price flex-wrap p-4">
                        <span class="value font-size-18 text-gray-6 font-weight-bold">
                            <div><?php echo e(format_money($row->price_per_hour)); ?><small><?php echo e(__("/per ticket")); ?></small></div>
                        </span>
                    </div>
                </div>
                        ...
                        <div class="form-content">
                            <div class="form-group form-guest-search flex-wrap">
                                <div class="d-block text-gray-1 font-weight-normal mb-0 text-left">
                                    <label><?php echo e(__("Number of Tickets")); ?></label>
                                </div>
                                <div class="mb-4">
                                    <div class="border-bottom border-width-2 border-color-1 pb-3">
                                        <div class="flex-center-between mb-1 text-dark font-weight-bold">
                                            <span class="d-block">
                                                <?php echo e(__('Tickets')); ?> <br>
                                            </span>
                                            <div class="flex-horizontal-center">
                                                <a class="font-size-10 text-dark" href="javascript:;" @click="minusHour()">
                                                    <i class="fa fa-chevron-down"></i>
                                                </a>
                                                <input class="form-control h-auto width-30 font-weight-bold font-size-16 shadow-none bg-tranparent border-0 rounded p-0 mx-1 text-center"  type="text"  v-model="hour" min="1">
                            ...
                            <span class="d-block text-gray-1 font-weight-normal mb-0 text-left"><?php echo e(__("Select Date")); ?></span>
                            <div class="mb-4">
...
<?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\themes/Mytravel/Boat/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>