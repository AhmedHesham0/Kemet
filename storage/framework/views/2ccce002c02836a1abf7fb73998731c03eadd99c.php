<div class="g-rules border-bottom">
    <h3 class="font-size-21 font-weight-bold text-dark mb-4"><?php echo e(__("Reservation Rules - Policies")); ?></h3>
    <div class="description">
        <div class="row">
            <div class="col-lg-4">
                <div class="key"><?php echo e(__("Start of Tour")); ?></div>
            </div>
            <div class="col-lg-8">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="key"><?php echo e(__("End of Tour")); ?></div>
            </div>
            <div class="col-lg-8">
        ...
        <?php if($translation->policy): ?>
            <div class="row">
                <div class="col-lg-4">
                    <div class="key"><?php echo e(__("Trip Policies")); ?></div>
                </div>
                <div class="col-lg-8">
...
</div><?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\themes/Mytravel/Hotel/Views/frontend/layouts/details/hotel-rules-policy.blade.php ENDPATH**/ ?>