        ...
        <div class="bravo-list-item">
            <div class="d-flex justify-content-between align-items-center mb-4 topbar-search">
                <h3 class="font-size-21 font-weight-bold mb-0 text-lh-1">
                    <?php if($rows->total() > 1): ?>
                        <?php echo e(__(":count restaurants found",['count'=>$rows->total()])); ?>

                    <?php else: ?>
                        <?php echo e(__(":count restaurant found",['count'=>$rows->total()])); ?>
            ...
            <div class="list-item">
                <div class="row">
                    ...
                    <?php else: ?>
                        <div class="col-lg-12">
                            <?php echo e(__("Restaurant not found")); ?>
            ...
            <?php if($rows->total() > 0): ?>
                <div class="text-center text-md-left font-size-14 mb-3 text-lh-1"><?php echo e(__("Showing :from - :to of :total restaurants",["from"=>$rows->firstItem(),"to"=>$rows->lastItem(),"total"=>$rows->total()])); ?></div>
            <?php endif; ?>
...
<?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\themes/Mytravel/Event/Views/frontend/layouts/search/list-item.blade.php ENDPATH**/ ?>