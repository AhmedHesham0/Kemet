                ...
                <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(empty($item['hide_in_filter_search'])): ?>
                        <?php
                            ...
                            // Skip Event Type attribute
                            if (strtolower($translate->name) === 'event type') {
                                continue;
                            }
                        ?>
...
<?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\themes/Mytravel/Event/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>