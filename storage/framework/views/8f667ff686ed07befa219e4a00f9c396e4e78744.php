...
<?php $__env->startSection('content'); ?>
	<div class="container-fluid">
		<div class="d-flex justify-content-between mb20">
			<h1 class="title-bar"><?php echo e(!empty($recovery) ? __('Recovery') : __("All Nature")); ?></h1>
			<div class="title-actions">
				<?php if(empty($recovery)): ?>
					<a href="<?php echo e(route('flight.admin.create')); ?>" class="btn btn-primary"><?php echo e(__("Add new nature")); ?></a>
				<?php endif; ?>
			</div>
		</div>
				...
				<form action="" class="bravo-form-item">
					<div class="table-responsive">
						<table class="table table-hover">
							...
							<?php else: ?>
								<tr>
									<td colspan="7"><?php echo e(__("No nature found")); ?></td>
								</tr>
							<?php endif; ?>
							</tbody>
						</table>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\modules/Flight/Views/admin/index.blade.php ENDPATH**/ ?>