        ...
        <div class="row">
            <div class="col-12 col-lg-5">
                ...
                <form class="form bravo-form-register-vendor" method="post" action="<?php echo e(route('vendor.register')); ?>">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="tax_id" autocomplete="off" placeholder="<?php echo e(__("Tax ID")); ?>">
                        <span class="invalid-feedback error error-tax_id"></span>
                    </div>
                    <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\themes/Base/Vendor/Views/frontend/blocks/form-register/index.blade.php ENDPATH**/ ?>