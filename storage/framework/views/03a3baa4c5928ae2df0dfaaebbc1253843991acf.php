                                            ...
                                            <?php if($key <= 2 ): ?>
                                                ...
                                                <div class="form-group d-flex align-items-center justify-content-between font-size-1 text-lh-md text-secondary mb-3">
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <label class="custom-control-label" for="term_<?php echo e($term->id); ?>"><?php echo __($translate->name); ?></label>
                                                    </div>
...
<?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\themes/Mytravel/Hotel/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>