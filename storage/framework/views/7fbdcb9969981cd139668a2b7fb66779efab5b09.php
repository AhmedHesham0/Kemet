                ...
                <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(empty($item['hide_in_filter_search'])): ?>
                        <?php
                            ...
                            // Skip Travel Styles and Facilities attributes
                            if (in_array(strtolower($translate->name), ['travel styles', 'facilities'])) {
                                continue;
                            }
                        ?>
...
<?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\themes/Mytravel/Tour/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>