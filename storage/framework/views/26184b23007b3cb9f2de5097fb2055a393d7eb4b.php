<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(!empty($recovery) ? __('Recovery') : __("All Tour Guides")); ?></h1>
            <div class="title-actions">
                <?php if(empty($recovery)): ?>
                <a href="<?php echo e(route('hotel.admin.create')); ?>" class="btn btn-primary"><?php echo e(__("Add new tour guide")); ?></a>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="panel-body">
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="<?php echo e(route('hotel.admin.edit',['id'=>$row->id])); ?>"><?php echo e(__("Edit Tour Guide")); ?></a>
                                                <a class="dropdown-item" href="<?php echo e(route('hotel.admin.room.index',['hotel_id'=>$row->id])); ?>"><?php echo e(__("Manage Tour Guide")); ?></a>
                                                <a class="dropdown-item" href="<?php echo e(route('hotel.admin.room.availability.index',['hotel_id'=>$row->id])); ?>"><?php echo e(__("Manage Tour Guide Availability")); ?></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7"><?php echo e(__("No Tour Guide found")); ?></td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\modules/Hotel/Views/admin/index.blade.php ENDPATH**/ ?>