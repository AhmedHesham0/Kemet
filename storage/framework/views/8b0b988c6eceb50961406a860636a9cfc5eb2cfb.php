<div id="hotel-rooms" class="hotel_rooms_form mt-4" v-cloak="" :class="{'d-none':enquiry_type!='book'}">
    <h5 class="font-size-21 font-weight-bold text-dark mb-4">
        <?php echo e(__("Select Your Date")); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group form-date-field form-date-search " @click="openStartDate" data-format="<?php echo e(get_moment_date_format()); ?>">
                        ...
                        <div class="date-wrapper form-content" >
                            <label class="form-label"><?php echo e(__("Reserve Date")); ?></label>
                            ...
                            <div class="col-md-3" v-if="room.number">
                                <div class="col-price clear">
                                    ...
                                    <select v-if="room.number" v-model="room.number_selected" class="custom-select">
                                        ...
                                        <option v-for="i in (1,room.number)" :value="i">{{i+' '+ (i > 1 ? i18n.room  : i18n.room)}} &nbsp;&nbsp; ({{formatMoney(i*room.price)}})</option>
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row row_total_price">
                <div class="col-md-6">
                    <div class="extra-price-wrap d-flex justify-content-between">
                        <div class="flex-grow-1">
                            <label>
                                <?php echo e(__("Total Number of Guests")); ?>:
                            </label>
                        </div>
...
<?php /**PATH C:\Users\AHmed's PC\Downloads\Mytravel.1.3.1\themes/Mytravel/Hotel/Views/frontend/layouts/details/hotel-rooms.blade.php ENDPATH**/ ?>