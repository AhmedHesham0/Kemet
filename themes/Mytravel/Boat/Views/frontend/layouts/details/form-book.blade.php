                ...
                <div class="border-bottom">
                    <div class="price flex-wrap p-4">
                        <span class="value font-size-18 text-gray-6 font-weight-bold">
                            <div>{{ format_money($row->price_per_hour) }}<small>{{ __("/per ticket") }}</small></div>
                        </span>
                    </div>
                </div>
                        ...
                        <div class="form-content">
                            <div class="form-group form-guest-search flex-wrap">
                                <div class="d-block text-gray-1 font-weight-normal mb-0 text-left">
                                    <label>{{__("Number of Tickets")}}</label>
                                </div>
                                <div class="mb-4">
                            ...
                            <span class="d-block text-gray-1 font-weight-normal mb-0 text-left">{{ __("Select Date") }}</span>
                            <div class="mb-4">
