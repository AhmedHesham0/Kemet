<div class="row">
    ...
    <div class="col-lg-9 col-md-12">
        <div class="bravo-list-item">
            ...
            @if($rows->total() > 0)
                <div class="text-center text-md-left font-size-14 mb-3 text-lh-1">{{ __("Showing :from - :to of :total restaurants",["from"=>$rows->firstItem(),"to"=>$rows->lastItem(),"total"=>$rows->total()]) }}</div>
            @endif
