...
@section ('content')
    <div class="d-flex justify-content-between mb20">
        <h1 class="title-bar">{{__('Room Availability')}}</h1>
        <a href="{{route('hotel.vendor.room.index',['hotel_id'=>$hotel->id])}}" class="btn btn-info">
            <i class="fa fa-hand-o-right"></i> {{__("Manage Tour Guide")}}
        </a>
    </div>
