<div class="g-rules border-bottom">
    <h3 class="font-size-21 font-weight-bold text-dark mb-4">{{__("Reservation Rules - Policies")}}</h3>
    <div class="description">
        <div class="row">
            <div class="col-lg-4">
                <div class="key">{{__("Start of Tour")}}</div>
            </div>
            <div class="col-lg-8">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="key">{{__("End of Tour")}}</div>
            </div>
            <div class="col-lg-8">
        ...
        @if($translation->policy)
            <div class="row">
                <div class="col-lg-4">
                    <div class="key">{{__("Trip Policies")}}</div>
                </div>
                <div class="col-lg-8">
