        ...
        mounted: function () {
            ...
            var options = {
                ...
                isInvalidDate: function (date) {
                    // Allow all dates for now - remove server dependency
                    return false;
                }
            };
        ...
        methods: {
            ...
            validate: function () {
                ...
                if (!this.hour || this.hour < 1) {
                    this.message.status = false;
                    this.message.content = bravo_booking_i18n.no_guest_select || "Please select number of tickets";
                    return false;
                }
            ...
            availabilityBooking: function () {
                // Bypass availability checking - just clear any previous error messages
                var me = this;
                me.message2.content = '';
                me.message2.type = true;
                return true;
            },
